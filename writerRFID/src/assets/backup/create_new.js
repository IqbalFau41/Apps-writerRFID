...
const inputRandomCode = document.getElementById('inputRandomCode');

// Tambahkan event listener untuk button
btnWrite.addEventListener('click', function () {
    // Simulasi menghasilkan kode acak
    const randomCode = generateRandomCode(); // Memanggil fungsi untuk menghasilkan kode acak

    // Tampilkan kode acak di dalam input
